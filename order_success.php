...
<body>
    <div class="success-container">
        ...
        <p>Cảm ơn bạn đã mua hàng tại cửa hàng chúng tôi. Đơn hàng của bạn đã được xác nhận.</p>
        <div class="order-info">
            ...
            <p><strong>Phương thức thanh toán:</strong> <?php echo $order['payment_method'] === 'COD' ? 'Thanh toán khi nhận hàng (COD)' : 'Thanh toán online'; ?></p>
